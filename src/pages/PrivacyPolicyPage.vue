...
import LegalPage, { type LegalSection } from '../components/common/LegalPage.vue';
import { usePageMeta } from '../composables/usePageMeta';

usePageMeta({
  title: 'Privacy Policy – maxstash',
  description:
    'Privacy policy for maxstash and its hosted applications, covering how we collect, use, and protect your information.',
  canonical: 'https://maxstash.io/privacy-policy',
});
...
const sections: LegalSection[] = [
  ...
  },
  {
    ...
    content: [
      ...
      'Account information (name, email address, authentication details from your sign-in provider)',
      'Contest information (squares you claim, contests and tournaments you create or join)',
...
<template>
  <LegalPage title="Privacy Policy" last-updated="July 12, 2026" :sections="sections" />
</template>
